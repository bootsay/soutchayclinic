...
export const utils = {
    ...
    setApiPath(path, queryObj) {
        ...
        return this.joinPaths([import.meta.env.VITE_API_PATH, path]);
    },
    ...
    getFileFullPath(path) {
        ...
        return this.joinPaths([import.meta.env.VITE_API_URL, path]);
    },
    isExternalFile(path) {
        let fullPath = this.getFileFullPath(path);
        let baseUrl = import.meta.env.VITE_API_URL; //app base url
