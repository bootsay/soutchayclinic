                                        ...
                                        <div class="col-span-full">
                                            <div class="mb-3 grid grid-cols-12 gap-4">
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            ...
                                                            <div class="font-bold">{{ item.staff_id }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                ...
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            <div class="text-gray-600 mb-1">Role</div>
...
<script setup>
	...
	import StaffEditPage from 'src/pages/staff/edit.vue';
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: StaffEditPage, url: `/staff/edit/${data.staff_id}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
