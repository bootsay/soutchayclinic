                                    ...
                                    <div class="mb-3 grid grid-cols-12 gap-4">
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Product Id</div>
                                                    <div class="font-bold">{{ item.product_id }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-full md:col-span-4">
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Stock Quantity</div>
                                                    <div class="font-bold">{{ item.stock_quantity }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Cost Price</div>
                                                    <div class="font-bold">{{ item.cost_price }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Sale Price</div>
                                                    <div class="font-bold">{{ item.sale_price }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script setup>
	...
	import ProductsEditPage from 'src/pages/products/edit.vue';
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: ProductsEditPage, url: `/products/edit/${data.product_id}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
