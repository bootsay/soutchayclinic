                                    ...
                                    <div class="mb-3 grid grid-cols-12 gap-4">
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Permission Id</div>
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Permission</div>
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Role Id</div>
                                                    <div class="font-bold">
                                                        <Button variant="text" icon="pi pi-eye" label="Roles Detail" v-if="item.role_id" @click="app.openPageDialog({ component: RolesViewPage, url: `/roles/view/${item.role_id}` , closeBtn: true })" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	import PermissionsEditPage from 'src/pages/permissions/edit.vue';
import RolesViewPage from 'src/pages/roles/view.vue';
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: PermissionsEditPage, url: `/permissions/edit/${data.permission_id}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
