        ...
        <template v-if="showHeader">
            ...
            <section class="page-section mb-3" >
                <div class="flex flex-wrap justify-between items-center gap-3">
                    <div  class="col-span-full " >
                        <Button label="Add Permission" icon="pi pi-plus"  @click="app.openPageDialog({ component: PermissionsAddPage, url: `/permissions/add` , closeBtn: true })"  class="p-button w-full bg-primary "  />
                    </div>
                    <div  class="col-span-full " >
                    ...
                    <div  class="col-span-full comp-grid" >
                        ...
                        <div >
                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"  :value="records" dataKey="permission_id" @sort="onSort($event)" class=" p-datatable-sm" :stripedRows ="true" :showGridlines="false" :rowHover="true" responsiveLayout="stack">
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        <Column  field="permission_id" header="Permission Id" >
                                            <template #body="{ data, index }">
                                                <router-link class="p-button-text" :to="`/permissions/view/${data.permission_id}`">
                                                    {{ data.permission_id }}
                                                </router-link>
                                            </template>
                                        </Column>
                                        ...
                                        <Column  field="role_id" header="Role Id" >
                                            <template #body="{ data, index }">
                                                <Button variant="text" icon="pi pi-eye" label="Roles" v-if="data.role_id" @click="app.openPageDialog({ component: RolesViewPage, url: `/roles/view/${data.role_id}` , closeBtn: true })" />
                                            </template>
                                        </Column>
                                ...
                                <template v-if="showFooter && pageReady">
                                    <div class="flex justify-between items-center">
                                        <div class="flex gap-2 flex-grow-0 mt-3">
                                            ...
                                            <import-data label="Select a file to import" ref="dataimport" upload-path="permissions/importdata" @importComplete="importComplete">
...
<script setup>
	...
	import PermissionsAddPage from 'src/pages/permissions/add.vue';
