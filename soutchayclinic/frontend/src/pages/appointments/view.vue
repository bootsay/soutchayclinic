                                        ...
                                        <div class="col-span-full">
                                            <div class="mb-3 grid grid-cols-12 gap-4">
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            ...
                                                            <div class="font-bold">{{ item.appointment_id }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            ...
                                                            <div class="font-bold">
                                                                <Button variant="text" icon="pi pi-eye" label="Patients Detail" v-if="item.patient_id" @click="app.openPageDialog({ component: PatientsViewPage, url: `/patients/view/${item.patient_id}` , closeBtn: true })" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            <div class="text-gray-600 mb-1">Service Id</div>
                                                            <div class="font-bold">
                                                                <Button variant="text" icon="pi pi-eye" label="Services Detail" v-if="item.service_id" @click="app.openPageDialog({ component: ServicesViewPage, url: `/services/view/${item.service_id}` , closeBtn: true })" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            <div class="text-gray-600 mb-1">Staff Id</div>
                                                            <div class="font-bold">
                                                                <Button variant="text" icon="pi pi-eye" label="Staff Detail" v-if="item.staff_id" @click="app.openPageDialog({ component: StaffViewPage, url: `/staff/view/${item.staff_id}` , closeBtn: true })" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            ...
                                                            <div class="font-bold">{{ item.appointment_date }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                ...
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            ...
                                                            <div class="font-bold">{{ item.notes }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script setup>
	...
	import AppointmentsEditPage from 'src/pages/appointments/edit.vue';
...
import StaffViewPage from 'src/pages/staff/view.vue';
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: AppointmentsEditPage, url: `/appointments/edit/${data.appointment_id}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	onMounted(()=>{ 
		const pageTitle = "Appointment Details";
