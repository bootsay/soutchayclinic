                                        ...
                                        <div class="col-span-full">
                                            <div class="mb-3 grid grid-cols-12 gap-4">
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            ...
                                                            <div class="font-bold">{{ item.service_id }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                ...
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            <div class="text-gray-600 mb-1">Duration Min</div>
                                                            <div class="font-bold">{{ item.duration_min }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-span-full md:col-span-4">
                                                ...
                                                <div class="col-span-full md:col-span-4">
                                                    <div class="flex gap-2 items-center card p-3 ">
                                                        <div>
                                                            <div class="text-gray-600 mb-1">Is Active</div>
...
<script setup>
	...
	import ServicesEditPage from 'src/pages/services/edit.vue';
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: ServicesEditPage, url: `/services/edit/${data.service_id}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
