                                    ...
                                    <div class="mb-3 grid grid-cols-12 gap-4">
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Userid</div>
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Username</div>
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Displayname</div>
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Phonenumber</div>
                                                    <div class="font-bold">{{ item.phonenumber }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">User Role Id</div>
                                                    <div class="font-bold">
                                                        <Button variant="text" icon="pi pi-eye" label="Roles Detail" v-if="item.user_role_id" @click="app.openPageDialog({ component: RolesViewPage, url: `/roles/view/${item.user_role_id}` , closeBtn: true })" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
import UserEditPage from 'src/pages/user/edit.vue';
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: UserEditPage, url: `/user/edit/${data.userid}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
