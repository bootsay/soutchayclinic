                                    ...
                                    <div class="mb-3 grid grid-cols-12 gap-4">
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Record Id</div>
                                        ...
                                        <div class="col-span-full md:col-span-4">
                                            <div class="flex gap-2 items-center card p-3 ">
                                                <div>
                                                    <div class="text-gray-600 mb-1">Treatment Result</div>
                                                    <div class="font-bold">{{ item.treatment_result }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-span-full md:col-span-4">
...
import TreatmentrecordsEditPage from 'src/pages/treatmentrecords/edit.vue';
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'treatmentrecordsview',
		},
		apiPath: {
			type: String,
			default: 'treatmentrecords/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog({ component: TreatmentrecordsEditPage, url: `/treatmentrecords/edit/${data.record_id}`, closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	onMounted(()=>{ 
		const pageTitle = "Treatment Record Details";
